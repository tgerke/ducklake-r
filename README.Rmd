...
- [Data Checks](https://tgerke.github.io/ducklake-r/articles/data-checks.html) - Validation rules stored in the lake as views, run on demand or as a gate before a commit
...
- [Visualizing Your Lake](https://tgerke.github.io/ducklake-r/articles/visualizing-your-lake.html) - Plot snapshot history, change volume, and storage layout, and browse changed rows in an interactive viewer
...
- **Multi-backend catalogs**: Use DuckDB (default), PostgreSQL, SQLite, or MySQL as the catalog database. A PostgreSQL or SQLite catalog lets several clients use the lake at once ([DuckLake 1.0 spec](https://ducklake.select/docs/stable/specification/introduction))
