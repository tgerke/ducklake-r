...
cars_data |>
  ...
  head(3)
#> # A query:  ?? x 3
#> # Database: DuckDB 1.5.5 [unknown@Linux 6.17.0-1022-azure:R 4.6.1//tmp/RtmpnrjRnl/ducklake/ducklake2bb54573cae8.duckdb]
#>     mpg   cyl    hp
#>   <dbl> <dbl> <dbl>
#> 1  21       6   110
#> 2  21       6   110
...
#> 1           1 2026-09-09 16:07:22              1
#> 2           2 2026-09-09 16:07:23              2
#>                                                              changes
...
passed to
[`with_transaction()`](https://tgerke.github.io/ducklake-r/reference/with_transaction.md),
and `snapshot_id` is the number from the confirmation. Any earlier
version can be read as a lazy table:
