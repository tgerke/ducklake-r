...
This ensures ADSL and ADAE stay synchronized - either both get the new `ANALYSISFL` column or neither does. Both updates are also versioned for audit trails.
...
- `vignette("upsert-operations")` - Upsert operations
