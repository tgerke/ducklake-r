...
and a message, like a change to the data. `create_view()` replaces a view
of the same name and keeps its label. This revision changes what the rule
says, so it sets a new label in the same transaction:
